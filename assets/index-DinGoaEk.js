	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}fi.BlurDirectionX=new ge(1,0);fi.BlurDirectionY=new ge(0,1);class Bp{constructor(e){this.canvas=e;const{width:t,height:n}=this._getViewportSize();this.arenaSize=6e3,this.scene=new Sp,this.scene.background=new Ee(394768),this.scene.fog=new Ar(394768,15e-5),this.camera=new Ut(60,t/n,1,1e4),this.camera.position.set(0,0,800),this.camera.lookAt(0,0,0),this.cameraTarget={x:0,y:0,z:800},this.cameraSmoothing=.5;const s=window.innerWidth<=1200;this.renderer=new el({canvas:e,antialias:!1,alpha:!1,powerPreference:"high-performance"}),this.renderer.setSize(t,n,!1),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,s?1:1.5)),this.renderer.toneMapping=So,this.renderer.toneMappingExposure=1.2;const r=Math.round(t*.5),o=Math.round(n*.5);this.composer=new Np(this.renderer);const a=new Fp(this.scene,this.camera);this.composer.addPass(a),this.bloomPass=new fi(new ge(r,o),1.2,.4,.85),this.composer.addPass(this.bloomPass),this.scene.add(new Rp(2236996,.5)),this._resizeTimeout=null,window.addEventListener("resize",()=>{clearTimeout(this._resizeTimeout),this._resizeTimeout=setTimeout(()=>this._onResize(),200)})}_getViewportSize(){const e=this.canvas.clientWidth||window.innerWidth,t=this.canvas.clientHeight||window.innerHeight;return{width:Math.max(1,e),height:Math.max(1,t)}}_onResize(){const{width:e,height:t}=this._getViewportSize();this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.composer.setSize(e,t);const n=Math.round(e*.5),s=Math.round(t*.5);this.bloomPass.resolution.set(n,s)}setCameraTarget(e,t,n){this.cameraTarget.x=this._getWrappedTarget(this.cameraTarget.x,e),this.cameraTarget.y=this._getWrappedTarget(this.cameraTarget.y,t),this.cameraTarget.z=800+Math.min(n*2,600)}setArenaSize(e){this.arenaSize=e||this.arenaSize}updateCamera(){const e=this.cameraSmoothing;this.camera.position.x+=(this.cameraTarget.x-this.camera.position.x)*e,this.camera.position.y+=(this.cameraTarget.y-this.camera.position.y)*e,this.camera.position.z+=(this.cameraTarget.z-this.camera.position.z)*e*.5,this.camera.position.x=this._normalizeWrappedCoord(this.camera.position.x),this.camera.position.y=this._normalizeWrappedCoord(this.camera.position.y),this.cameraTarget.x=this._normalizeWrappedCoord(this.cameraTarget.x),this.cameraTarget.y=this._normalizeWrappedCoord(this.cameraTarget.y),this.camera.lookAt(this.camera.position.x,this.camera.position.y,0)}_getWrappedTarget(e,t){const n=this.arenaSize;if(!n)return t;let s=t-e;const r=n/2;return s>r&&(s-=n),s<-r&&(s+=n),e+s}_normalizeWrappedCoord(e){const t=this.arenaSize;if(!t)return e;const n=t/2;return e>n?e-t:e<-n?e+t:e}render(){this.updateCamera(),this.composer.render()}getScene(){return this.scene}}class zp{constructor(e){this.scene=e,this.snakes=new Map,this.lastUpdateTime=performance.now(),this.arenaSize=6e3,this.segmentGeo=new li(1,6,4),this.headGeo=new li(1,8,6),this.eyeGeo=new li(1,4,3),this.sharedEyeMat=new Ci({color:16777215,emissive:16777215,emissiveIntensity:2})}setArenaSize(e){this.arenaSize=e||this.arenaSize}_createSnakeMaterial(e){return new Ci({color:new Ee().setHSL(e/360,1,.5),emissive:new Ee().setHSL(e/360,1,.3),emissiveIntensity:.8,roughness:.3,metalness:.7})}_createHeadMaterial(e){return new Ci({color:new Ee().setHSL(e/360,1,.6),emissive:new Ee().setHSL(e/360,1,.4),emissiveIntensity:1.2,roughness:.2,metalness:.8})}updateSnake(e,t=!1){const n=e.id,s=e.segs||e.segments||[];if(s.length===0)return;const r=e.hue||0,o=e.hr||e.headRadius||12,a=e.bst||e.boosting||!1,l=e.sc||e.score||0;let c=this.snakes.get(n);if(!c){c={container:new wi,bodyMeshes:[],headMesh:null,eyes:[],nameMesh:null,hue:r,material:this._createSnakeMaterial(r),headMaterial:this._createHeadMaterial(r),targetSegments:[],renderSegments:[],headRadius:12,dir:null,targetDir:0,boosting:0,targetBoosting:!1,phaseActive:!1,score:0,isSelf:t},c.headMesh=new pt(this.headGeo,c.headMaterial),c.container.add(c.headMesh);for(let g=0;g<2;g++){const x=new pt(this.eyeGeo,this.sharedEyeMat);c.eyes.push(x),c.container.add(x)}if(e.name){const g=document.createElement("canvas");g.width=256,g.height=64;const x=g.getContext("2d");x.font='bold 28px "Rajdhani", sans-serif',x.textAlign="center",x.textBaseline="middle";const f=e.name.substring(0,16);x.lineWidth=4,x.strokeStyle="#000000",x.strokeText(f,128,32),x.fillStyle=t?"#00f0ff":"#ffffff",x.fillText(f,128,32);const u=new Ap(g);u.minFilter=Et,u.generateMipmaps=!1;const E=new tl({map:u,transparent:!0,opacity:1});c.nameMesh=new Ep(E),c.nameMesh.scale.set(120,30,1),c.container.add(c.nameMesh)}this.scene.add(c.container),this.snakes.set(n,c)}const h=s.length,d=t?200:100,p=Math.min(h,d),m=h>d?h/d:1;for(;c.bodyMeshes.length<p;){const g=new pt(this.segmentGeo,c.material);c.bodyMeshes.push(g),c.container.add(g)}c.targetSegments.length=p,c.renderSegments.length=p;for(let g=0;g<p;g++){const x=m===1?g:Math.min(Math.round(g*m),h-1),f=s[x],u=Array.isArray(f)?f[0]:f.x,E=Array.isArray(f)?f[1]:f.y;c.targetSegments[g]?(c.targetSegments[g].x=u,c.targetSegments[g].y=E):c.targetSegments[g]={x:u,y:E},c.renderSegments[g]||(c.renderSegments[g]={x:u,y:E})}for(let g=p;g<c.bodyMeshes.length;g++)c.bodyMeshes[g].visible=!1;c.headRadius=o,c.score=l,c.targetDir=e.dir||e.direction||0,c.dir===null&&(c.dir=c.targetDir),c.targetBoosting=a,c.phaseActive=(e.pu||0)===2,this._applySnakeVisuals(c)}update(e=performance.now()){const t=Math.min(.05,(e-this.lastUpdateTime)/1e3||.016);this.lastUpdateTime=e;const n=1-Math.exp(-t*14),s=1-Math.exp(-t*10);for(const r of this.snakes.values()){const o=r.targetSegments.length;if(!o)continue;for(let l=0;l<o;l++){const c=r.renderSegments[l],h=r.targetSegments[l];c.x=this._interpolateWrapped(c.x,h.x,n),c.y=this._interpolateWrapped(c.y,h.y,n)}r.dir=this._lerpAngle(r.dir,r.targetDir,n);const a=r.targetBoosting?1:0;r.boosting+=(a-r.boosting)*s,this._applySnakeVisuals(r)}}_applySnakeVisuals(e){const t=e.targetSegments.length;if(t===0)return;const n=Math.min(e.score*.01,1),s=e.headRadius*(.8+n*.4),r=e.renderSegments[0];e.headMesh.position.set(r.x,r.y,5),e.headMesh.scale.setScalar(s);const o=Math.cos(e.dir),a=Math.sin(e.dir),l=o*s*.5,c=a*s*.5,h=s*.35;e.eyes[0].position.set(r.x+l-a*h,r.y+c+o*h,8),e.eyes[1].position.set(r.x+l+a*h,r.y+c-o*h,8),e.eyes[0].scale.setScalar(s*.25),e.eyes[1].scale.setScalar(s*.25),e.nameMesh&&e.nameMesh.position.set(r.x,r.y+s+25,10);const d=1/Math.max(1,t-1);for(let p=0;p<t;p++){const m=e.bodyMeshes[p],g=e.renderSegments[p];m.visible=!0,m.position.set(g.x,g.y,2);const x=p*d,f=s*(1-x*.5);m.scale.setScalar(f*.85)}e.material.emissiveIntensity=.8+e.boosting*.8,e.headMaterial.emissiveIntensity=1.2+e.boosting*.8,e.phaseActive?e.material.transparent||(e.material.opacity=.4,e.material.transparent=!0):e.material.transparent&&(e.material.opacity=1,e.material.transparent=!1,e.headMaterial.emissive.setHSL(e.hue/360,1,.4))}_lerpAngle(e,t,n){let s=t-e;for(;s>Math.PI;)s-=Math.PI*2;for(;s<-Math.PI;)s+=Math.PI*2;return e+s*n}_interpolateWrapped(e,t,n){const s=this._getWrappedDelta(e,t);return this._normalizeWrappedCoord(e+s*n)}_getWrappedDelta(e,t){const n=this.arenaSize;if(!n)return t-e;let s=t-e;const r=n/2;return s>r&&(s-=n),s<-r&&(s+=n),s}_normalizeWrappedCoord(e){const t=this.arenaSize;if(!t)return e;const n=t/2;return e>n?e-t:e<-n?e+t:e}removeSnake(e){var n;const t=this.snakes.get(e);t&&(this.scene.remove(t.container),t.material&&t.material.dispose(),t.headMaterial&&t.headMaterial.dispose(),t.nameMesh&&((n=t.nameMesh.material)!=null&&n.map&&t.nameMesh.material.map.dispose(),t.nameMesh.material&&t.nameMesh.material.dispose()),this.snakes.delete(e))}getActiveIds(){return new Set(this.snakes.keys())}clear(){for(const[e]of this.snakes)this.removeSnake(e)}}class Gp{constructor(e,t=6e3){this.scene=e,this.arenaSize=t,this.particles=null,this.particlePositions=null,this.particleCount=0,this._createGrid(),this._createBoundary(),this._createAmbientParticles()}_createGrid(){const e=this.arenaSize/2,t=200,n=new Ri({color:1714756,transparent:!0,opacity:.5}),s=[];for(let p=-e;p<=e;p+=t)s.push(new P(p,-e,0)),s.push(new P(p,e,0));for(let p=-e;p<=e;p+=t)s.push(new P(-e,p,0)),s.push(new P(e,p,0));const r=new st().setFromPoints(s),o=new po(r,n);o.position.z=-5,o.frustumCulled=!1,this.scene.add(o);const a=new Ri({color:1718368,transparent:!0,opacity:.7}),l=[],c=1e3;for(let p=-e;p<=e;p+=c)l.push(new P(p,-e,0)),l.push(new P(p,e,0));for(let p=-e;p<=e;p+=c)l.push(new P(-e,p,0)),l.push(new P(e,p,0));const h=new st().setFromPoints(l),d=new po(h,a);d.position.z=-4,d.frustumCulled=!1,this.scene.add(d)}_createBoundary(){const e=this.arenaSize/2,t=new Ri({color:16711782,transparent:!0,opacity:.5}),n=[new P(-e,-e,0),new P(e,-e,0),new P(e,e,0),new P(-e,e,0),new P(-e,-e,0)],s=new st().setFromPoints(n),r=new xr(s,t);r.position.z=-3,this.scene.add(r);const o=new Ri({color:16711782,transparent:!0,opacity:.15,linewidth:2}),a=new xr(s.clone(),o);a.position.z=-2,a.scale.setScalar(1.002),this.scene.add(a)}_createAmbientParticles(){this.particleCount=200;const t=new Float32Array(200*3),n=new Float32Array(200*3);for(let o=0;o<200;o++){t[o*3]=(Math.random()-.5)*this.arenaSize,t[o*3+1]=(Math.random()-.5)*this.arenaSize,t[o*3+2]=-10+Math.random()*20;const a=Math.random();a<.33?(n[o*3]=0,n[o*3+1]=.94,n[o*3+2]=1):a<.66?(n[o*3]=1,n[o*3+1]=0,n[o*3+2]=.67):(n[o*3]=.67,n[o*3+1]=0,n[o*3+2]=1)}this.particlePositions=t;const s=new st;s.setAttribute("position",new xt(t,3)),s.setAttribute("color",new xt(n,3));const r=new wr({size:3,vertexColors:!0,transparent:!0,opacity:.2,blending:Dn,depthWrite:!1,sizeAttenuation:!0});this.particles=new il(s,r),this.scene.add(this.particles)}update(e){if(this.particlePositions&&(e|0)%3===0){const t=this.particlePositions,n=e*5e-4,s=e*3e-4;for(let r=0;r<this.particleCount;r++)t[r*3+1]+=Math.sin(n+r)*.1,t[r*3]+=Math.cos(s+r*.7)*.05;this.particles.geometry.attributes.position.needsUpdate=!0}}}class Hp{constructor(e){this.scene=e,this.maxOrbs=1500;const t=new li(3,4,3);this.normalMaterial=new Ci({color:65416,emissive:65348,emissiveIntensity:1,roughness:.3,metalness:.5,transparent:!0,opacity:.9}),this.specialMaterial=new Ci({color:16772608,emissive:16755200,emissiveIntensity:1.5,roughness:.2,metalness:.6,transparent:!0,opacity:.9}),this.normalMesh=new oo(t,this.normalMaterial,this.maxOrbs),this.normalMesh.count=0,this.normalMesh.frustumCulled=!1,this.scene.add(this.normalMesh),this.specialMesh=new oo(t,this.specialMaterial,100),this.specialMesh.count=0,this.specialMesh.frustumCulled=!1,this.scene.add(this.specialMesh),this.dummy=new ct,this._pulseFrame=0}updateOrbs(e){if(!e||!Array.isArray(e))return;let t=0,n=0;for(let s=0;s<e.length;s++){const r=e[s],o=Array.isArray(r)?r[1]:r.x,a=Array.isArray(r)?r[2]:r.y,l=Array.isArray(r)?r[3]:r.value||1;if(Array.isArray(r)?r[4]:r.type==="special"){if(n<100){const h=2.5+l*1.5;this.dummy.position.set(o,a,2),this.dummy.scale.setScalar(h),this.dummy.updateMatrix(),this.specialMesh.setMatrixAt(n,this.dummy.matrix),n++}}else if(t<this.maxOrbs){const h=1.5+l;this.dummy.position.set(o,a,0),this.dummy.scale.setScalar(h),this.dummy.updateMatrix(),this.normalMesh.setMatrixAt(t,this.dummy.matrix),t++}}this.normalMesh.count=t,t>0&&(this.normalMesh.instanceMatrix.needsUpdate=!0),this.specialMesh.count=n,n>0&&(this.specialMesh.instanceMatrix.needsUpdate=!0)}update(e){if(this._pulseFrame++,this._pulseFrame%4===0){const t=.8+Math.sin(e*.003)*.2;this.normalMaterial.emissiveIntensity=t,this.specialMaterial.emissiveIntensity=1+Math.sin(e*.005)*.5}}}class Vp{constructor(e){this.scene=e,this.explosions=[],this.surgeZones=new Map,this.maxParticlesPerExplosion=30,this._frame=0}createDeathExplosion(e,t,n=0){if(this.explosions.length>=5){const d=this.explosions.shift();this.scene.remove(d.points),d.points.geometry.dispose(),d.material.dispose()}const s=this.maxParticlesPerExplosion,r=new Float32Array(s*3),o=[],a=new Float32Array(s*3);for(let d=0;d<s;d++){r[d*3]=e,r[d*3+1]=t,r[d*3+2]=5;const p=Math.PI*2*d/s+(Math.random()-.5)*.5,m=2+Math.random()*6;o.push({vx:Math.cos(p)*m,vy:Math.sin(p)*m,life:1,decay:.012+Math.random()*.02});const g=new Ee().setHSL(n/360,1,.5+Math.random()*.3);a[d*3]=g.r,a[d*3+1]=g.g,a[d*3+2]=g.b}const l=new st;l.setAttribute("position",new xt(r,3)),l.setAttribute("color",new xt(a,3));const c=new wr({size:8,vertexColors:!0,transparent:!0,opacity:1,blending:Dn,depthWrite:!1,sizeAttenuation:!0}),h=new il(l,c);this.scene.add(h),this.explosions.push({points:h,velocities:o,positions:l.attributes.position.array,material:c,age:0})}addSurgeZone(e){const t=new Cr(e.radius-5,e.radius,32),n=new Pi({color:16772608,transparent:!0,opacity:.15,side:Ot,blending:Dn}),s=new pt(t,n);s.position.set(e.x,e.y,-1);const r=new Rr(e.radius,32),o=new Pi({color:16755200,transparent:!0,opacity:.03,side:Ot,blending:Dn}),a=new pt(r,o);a.position.set(e.x,e.y,-2),this.scene.add(s),this.scene.add(a),this.surgeZones.set(e.id,{ring:s,fill:a,material:n,fillMat:o})}removeSurgeZone(e){const t=this.surgeZones.get(e);t&&(this.scene.remove(t.ring),this.scene.remove(t.fill),t.material.dispose(),t.fillMat.dispose(),t.ring.geometry.dispose(),t.fill.geometry.dispose(),this.surgeZones.delete(e))}update(e){this._frame++;for(let t=this.explosions.length-1;t>=0;t--){const n=this.explosions[t];n.age++;let s=!0;for(let r=0;r<n.velocities.length;r++){const o=n.velocities[r];o.life<=0||(s=!1,n.positions[r*3]+=o.vx,n.positions[r*3+1]+=o.vy,o.vx*=.95,o.vy*=.95,o.life-=o.decay)}n.points.geometry.attributes.position.needsUpdate=!0,n.material.opacity=Math.max(0,1-n.age/60),(s||n.age>70)&&(this.scene.remove(n.points),n.points.geometry.dispose(),n.material.dispose(),this.explosions.splice(t,1))}if(this._frame%8===0)for(const[t,n]of this.surgeZones){const s=.1+Math.sin(e*.003)*.05;n.material.opacity=s,n.fillMat.opacity=.02+Math.sin(e*.004)*.01}}}class kp{constructor(){this.mouseX=window.innerWidth/2,this.mouseY=window.innerHeight/2,this.direction=0,this.boosting=!1,this.active=!1,this.isMobile=this._detectTouchMode(),this.mobileControlsReady=!1,this._bindEvents(),this._createMobileControls(),this._syncControlMode()}_detectTouchMode(){return("ontouchstart"in window||navigator.maxTouchPoints>0)&&window.innerWidth<=1200}_bindEvents(){window.addEventListener("mousemove",e=>{this.mouseX=e.clientX,this.mouseY=e.clientY,this._updateDirection()}),window.addEventListener("mousedown",e=>{e.button===0&&(this.boosting=!0)}),window.addEventListener("mouseup",e=>{e.button===0&&(this.boosting=!1)}),window.addEventListener("keydown",e=>{e.code==="Space"&&(e.preventDefault(),this.boosting=!0)}),window.addEventListener("keyup",e=>{e.code==="Space"&&(this.boosting=!1)}),document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault()),window.addEventListener("resize",()=>{const e=this._detectTouchMode();e!==this.isMobile&&(this.isMobile=e,this._syncControlMode())})}_createMobileControls(){if(this.mobileControlsReady)return;const e=document.getElementById("boost-wrapper"),t=document.getElementById("joystick-wrapper");if(!e||!t)return;this.mobileControlsReady=!0,this.vibrate=(f=10)=>{"vibrate"in navigator&&navigator.vibrate(f)};const n=document.createElement("div");n.id="mobile-boost-btn",n.innerHTML=`
      <div class="boost-btn-inner">
        <span class="boost-icon">⚡</span>
        <span class="boost-label">BOOST</span>
      </div>
    `,e.appendChild(n);const s=f=>{f.preventDefault(),f.stopPropagation(),this.boosting=!0,this.vibrate(15),n.classList.add("active")},r=f=>{f.preventDefault(),f.stopPropagation(),this.boosting=!1,n.classList.remove("active")};n.addEventListener("touchstart",s,{passive:!1}),n.addEventListener("touchend",r,{passive:!1}),n.addEventListener("touchcancel",r),n.addEventListener("pointerdown",f=>{f.pointerType==="mouse"&&s(f)}),n.addEventListener("pointerup",r),n.addEventListener("pointerleave",r),n.addEventListener("pointercancel",r);const o=document.getElementById("start-btn"),a=document.getElementById("select-btn"),l=f=>{f.preventDefault(),this.vibrate(20);const u=document.getElementById("play-btn");u&&u.offsetParent!==null&&u.click()},c=f=>{var E;f.preventDefault(),this.vibrate(10);const u=document.getElementById("player-name");u&&((E=document.getElementById("join-screen"))==null?void 0:E.style.display)!=="none"&&(u.focus(),u.select())};o&&(o.addEventListener("touchstart",l,{passive:!1}),o.addEventListener("click",l)),a&&(a.addEventListener("touchstart",c,{passive:!1}),a.addEventListener("click",c));const h=document.createElement("div");h.id="joystick-zone",t.appendChild(h);const d=document.createElement("div");d.className="joystick-base",d.innerHTML='<div class="joystick-stick"></div>',h.appendChild(d);const p=d.querySelector(".joystick-stick");let m=null;const g=35;h.addEventListener("touchstart",f=>{f.preventDefault();for(let u=0;u<f.changedTouches.length;u++){const E=f.changedTouches[u];if(m===null){m=E.identifier,this._handleJoystickMove(E,d,p,g);break}}},{passive:!1}),h.addEventListener("touchmove",f=>{if(f.preventDefault(),m!==null)for(let u=0;u<f.changedTouches.length;u++){const E=f.changedTouches[u];E.identifier===m&&this._handleJoystickMove(E,d,p,g)}},{passive:!1});const x=f=>{if(m!==null)for(let u=0;u<f.changedTouches.length;u++)f.changedTouches[u].identifier===m&&(m=null,p.style.transform="translate(-50%, -50%)")};h.addEventListener("touchend",x),h.addEventListener("touchcancel",x)}_syncControlMode(){document.body.classList.toggle("touch-device",this.isMobile),document.body.classList.toggle("desktop-device",!this.isMobile);const e=document.getElementById("console-mode-label");e&&(e.textContent=this.isMobile?"TOUCH MODE":"DESKTOP MODE");const t=document.getElementById("mobile-console");t&&t.style.display!=="none"&&(t.style.display=this.isMobile?"flex":"none")}_handleJoystickMove(e,t,n,s){const r=t.getBoundingClientRect(),o=r.left+r.width/2,a=r.top+r.height/2,l=e.clientX-o,c=e.clientY-a,h=Math.sqrt(l*l+c*c);let d=l,p=c;h>s&&(d=l/h*s,p=c/h*s),n.style.transform=`translate(calc(-50% + ${d}px), calc(-50% + ${p}px))`,h>5&&(this.direction=Math.atan2(-p,d))}show(){const e=document.getElementById("mobile-console");e&&(e.style.display=this.isMobile?"flex":"none")}hide(){const e=document.getElementById("mobile-console");e&&(e.style.display="none")}_updateDirection(){const e=window.innerWidth/2,t=window.innerHeight/2;this.direction=Math.atan2(t-this.mouseY,this.mouseX-e)}getState(){return{direction:this.direction,boosting:this.boosting}}}class Wp{constructor(){this.ws=null,this.connected=!1,this.playerId=null,this.onInit=null,this.onUpdate=null,this.onDeath=null,this.onPlayerDeath=null,this.onLeaderboard=null,this.onRespawn=null,this.onStats=null,this.lastInputTime=0,this.inputThrottle=33}connect(){const n=`${location.protocol==="https:"?"wss:":"ws:"}//ultimate-snake-game.onrender.com`;console.log(`Connecting to server: ${n}`),this.ws=new WebSocket(n),this.ws.onopen=()=>{this.connected=!0},this.ws.onmessage=s=>{try{const r=JSON.parse(s.data);switch(r.type){case"init":this.playerId=r.playerId,this.onInit&&this.onInit(r);break;case"update":this.onUpdate&&this.onUpdate(r);break;case"death":this.onDeath&&this.onDeath(r.data);break;case"playerDeath":this.onPlayerDeath&&this.onPlayerDeath(r);break;case"leaderboard":this.onLeaderboard&&this.onLeaderboard(r);break;case"respawn":this.onRespawn&&this.onRespawn(r);break;case"stats":this.onStats&&this.onStats(r);break}}catch{}},this.ws.onclose=()=>{this.connected=!1,setTimeout(()=>this.connect(),2e3)},this.ws.onerror=()=>{}}join(e){this.connected&&this.ws.send(JSON.stringify({type:"join",name:e}))}sendInput(e,t){if(!this.connected)return;const n=Date.now();n-this.lastInputTime<this.inputThrottle||(this.lastInputTime=n,this.ws.send(JSON.stringify({type:"input",dir:Math.round(e*100)/100,boost:t})))}sendBoost(e){this.connected&&this.ws.send(JSON.stringify({type:"boost",active:e}))}sendRespawn(){this.connected&&this.ws.send(JSON.stringify({type:"respawn"}))}}class Xp{constructor(){this.joinScreen=document.getElementById("join-screen"),this.gameContainer=document.getElementById("game-container"),this.deathScreen=document.getElementById("death-screen"),this.nameInput=document.getElementById("player-name"),this.playBtn=document.getElementById("play-btn"),this.respawnBtn=document.getElementById("respawn-btn"),this.scoreValue=document.getElementById("score-value"),this.lbList=document.getElementById("lb-list"),this.rankValue=document.getElementById("rank-value"),this.boostBar=document.getElementById("boost-bar"),this.powerupDisplay=document.getElementById("powerup-display"),this.minimapCanvas=document.getElementById("minimap"),this.minimapCtx=this.minimapCanvas.getContext("2d"),this.deathKiller=document.getElementById("death-killer"),this.deathScore=document.getElementById("death-score"),this.deathKills=document.getElementById("death-kills"),this.deathTime=document.getElementById("death-time"),this.currentScore=0,this.displayScore=0,this._initBgParticles()}_initBgParticles(){const e=document.getElementById("bg-particles");if(!e)return;for(let n=0;n<50;n++){const s=document.createElement("div");s.style.cssText=`
        position: absolute;
